 ...
 * hace este proyecto: la usa el flujo real de pedidos (lib/pedido-preferencia.js,
 * consumido por api/pedidos.js y api/pedidos-preferencia.js). El endpoint
 * de prueba api/create-payment-preference.js quedo deshabilitado y ya no
 * llama a este cliente (ver el comentario al inicio de ese archivo).
 *
 * Reglas de seguridad:
